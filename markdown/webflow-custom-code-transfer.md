...
- Webflow MCP server connected (`claude mcp add --transport stdio webflow -s local -- npx mcp-remote https://mcp.webflow.com/sse`)
...
**"MCP not connected"**
```bash
# Restart MCP connection (CRITICAL: --transport stdio flag required!)
claude mcp remove webflow -s local
claude mcp add --transport stdio webflow -s local -- npx mcp-remote https://mcp.webflow.com/sse
