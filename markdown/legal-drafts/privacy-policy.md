...
This policy governs **website use only**. Protected Health Information (PHI) collected during dental treatment is governed separately by our [Notice of Privacy Practices](/legal/notice-of-privacy-practices) under the Health Insurance Portability and Accountability Act (HIPAA).
...
We use the following services, each of which may collect information as described in its own privacy policy:

- **Google Analytics** — traffic and usage statistics. [Google's Privacy Policy](https://policies.google.com/privacy)
- **Webflow** — our website hosting platform. [Webflow's Privacy Policy](https://webflow.com/legal/privacy)
- **[Meta Pixel / Google Ads / other ad platforms — list only if actually installed]**
...
- **In a business transfer** — if TNCLD is sold, merged, or reorganized, information may transfer to the successor entity.
...
If you are or were a patient of TNCLD, you have rights over your Protected Health Information, including the right to access, amend, and restrict use. Those rights are detailed in our [Notice of Privacy Practices](/legal/notice-of-privacy-practices).
...
- **Opt out of sale or sharing** (TNCLD does not sell or share personal information as defined by CCPA)
- **Non-discrimination** for exercising these rights

To make a request, email **privacy@tncld.com** or call **(615) 595-8070**. We will verify your identity before processing requests.
...
Our website is not directed at children under 13, and we do not knowingly collect personal information from children through the website. If a parent or guardian believes their child has submitted personal information through our website, contact us at **privacy@tncld.com** and we will delete it.

**For pediatric dental patients:** information collected during care is governed by HIPAA and our Notice of Privacy Practices, with additional protections for minors under Tennessee law.

---

## 8. Third-Party Links

Our website may link to third-party websites (e.g., Google Maps, payment processors, social media). We are not responsible for the privacy practices or content of those sites. Review their privacy policies separately.

---

## 9. Data Retention

We retain website-submitted information only as long as necessary to respond to your inquiry or comply with legal obligations. Patient records are retained per Tennessee state law (typically 10 years from the last date of service for adults, longer for minors) and HIPAA requirements.
...
This Privacy Policy is available in alternative formats upon request. See our [Accessibility Statement](/legal/accessibility) for more information.
